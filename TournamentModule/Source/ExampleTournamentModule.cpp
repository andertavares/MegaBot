...
void TournamentAI::onEnd(bool isWinner)
{
...
void TournamentAI::drawTournamentModuleSettings(int x, int y)
{
	int drawX = x;
	int drawY = y;
	int width = 120;
...
void TournamentAI::drawUnitInformation(int x, int y) 
{
...
void TournamentAI::onSendText(std::string text)
{
	frameTimes[BWAPI::Broodwar->getFrameCount()] += BWAPI::Broodwar->getLastEventTime();
}

void TournamentAI::onReceiveText(BWAPI::Player* player, std::string text)
{
	frameTimes[BWAPI::Broodwar->getFrameCount()] += BWAPI::Broodwar->getLastEventTime();
}

void TournamentAI::onPlayerLeft(BWAPI::Player* player)
{
	frameTimes[BWAPI::Broodwar->getFrameCount()] += BWAPI::Broodwar->getLastEventTime();
}

void TournamentAI::onPlayerDropped(BWAPI::Player* player)
{
	frameTimes[BWAPI::Broodwar->getFrameCount()] += BWAPI::Broodwar->getLastEventTime();
}

void TournamentAI::onNukeDetect(BWAPI::Position target)
{
	frameTimes[BWAPI::Broodwar->getFrameCount()] += BWAPI::Broodwar->getLastEventTime();
}

void TournamentAI::onUnitDiscover(BWAPI::Unit* unit)
{
	frameTimes[BWAPI::Broodwar->getFrameCount()] += BWAPI::Broodwar->getLastEventTime();
}

void TournamentAI::onUnitEvade(BWAPI::Unit* unit)
{
	frameTimes[BWAPI::Broodwar->getFrameCount()] += BWAPI::Broodwar->getLastEventTime();
}

void TournamentAI::onUnitShow(BWAPI::Unit* unit)
{
	frameTimes[BWAPI::Broodwar->getFrameCount()] += BWAPI::Broodwar->getLastEventTime();
}

void TournamentAI::onUnitHide(BWAPI::Unit* unit)
{
	frameTimes[BWAPI::Broodwar->getFrameCount()] += BWAPI::Broodwar->getLastEventTime();
}

void TournamentAI::onUnitCreate(BWAPI::Unit* unit)
{
	frameTimes[BWAPI::Broodwar->getFrameCount()] += BWAPI::Broodwar->getLastEventTime();
...
void TournamentAI::onUnitDestroy(BWAPI::Unit* unit)
{
	frameTimes[BWAPI::Broodwar->getFrameCount()] += BWAPI::Broodwar->getLastEventTime();
}

void TournamentAI::onUnitMorph(BWAPI::Unit* unit)
{
	frameTimes[BWAPI::Broodwar->getFrameCount()] += BWAPI::Broodwar->getLastEventTime();
}

void TournamentAI::onUnitComplete(BWAPI::Unit *unit)
{
	frameTimes[BWAPI::Broodwar->getFrameCount()] += BWAPI::Broodwar->getLastEventTime();
}

void TournamentAI::onUnitRenegade(BWAPI::Unit* unit)
{
}

void TournamentAI::onSaveGame(std::string gameName)
{
}
...
std::vector<std::string> TournamentAI::getLines(const std::string & filename)
{
    // set up the file
...
void TournamentAI::parseConfigFile(const std::string & filename)
{
